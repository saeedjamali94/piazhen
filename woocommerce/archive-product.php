...
<main class="woo-archive">
    <div class="container">
        ...
        if ($current_category && $current_category->description) {
            ...
            if (!$seo_content) {
                $seo_content = __('فروشگاه اینترنتی پی‌آژن عرضه‌کننده انواع عطر و ادکلن اورجینال، لوازم آرایشی و محصولات بهداشتی با ضمانت اصالت کالا و بهترین قیمت است. تمامی محصولات پی‌آژن دارای گارانتی اصالت بوده و با ارسال سریع به سراسر کشور ارسال می‌شوند.', 'piazhen');
            }
            $seo_title = __('درباره فروشگاه پی‌آژن', 'piazhen');
        }
        ?>
        <?php if ($seo_content): ?>
